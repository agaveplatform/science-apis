...
{	
	...
	private void initJWT() throws Exception
	{
		JsonNode json = new ObjectMapper().createObjectNode()
				...
				.put("http://wso2.org/claims/subscriber", TEST_USER)
				...
				.put("http://wso2.org/claims/apicontext", "/monitors")
				...
				.put("http://wso2.org/claims/enduser", TEST_USER)
				.put("http://wso2.org/claims/enduserTenantId", "-9999")
				.put("http://wso2.org/claims/emailaddress", TEST_EMAIL)
	...
	private ClientResource getService(String url)
	{
    	...
    	headers.add("x-jwt-assertion-agave-dev", testJWT);
