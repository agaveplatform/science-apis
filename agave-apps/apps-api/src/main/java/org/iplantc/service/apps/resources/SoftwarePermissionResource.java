...
public interface SoftwarePermissionResource {
    ...
    @GET
    Response getUserSoftwarePermission(@PathParam("softwareId") String softwareId,
                                       @PathParam("sharedUsername") String sharedUsername);
	
	@POST
	@Consumes(MediaType.MULTIPART_FORM_DATA)
    Response updateUserSoftwarePermission(@PathParam("softwareId") String softwareId,
                                          @PathParam("sharedUsername") String sharedUsername,
                                          Representation input);
	
	@DELETE
    Response deleteUserSoftwarePermission(@PathParam("softwareId") String softwareId,
                                          @PathParam("sharedUsername") String sharedUsername);
//
//	@POST
