...
public class SystemManagerIT extends PersistedSystemsModelTestCommon
{	
	private final SystemManager manager = new SystemManager();
...
//		clearSystems();
    ...
    private RemoteSystem getPrivateStorageSystem() throws Exception {	
        RemoteSystem privateStorageSystem = StorageSystem.fromJSON( jtd.getTestDataObject(
                JSONTestDataUtil.TEST_STORAGE_SYSTEM_FILE).put("id",new UniqueId().getStringId()));
    ...
    private RemoteSystem getPublicReadonlyStorageSystem() throws Exception {   
        ...
        publicReadonlyStorageSystem.addRole(new SystemRole(Settings.PUBLIC_USER_USERNAME, RoleType.GUEST));
    ...
    private RemoteSystem getPrivateReadonlyStorageSystem() throws Exception {   
        ...
        publicReadonlyStorageSystem.setGlobalDefault(false);
        publicReadonlyStorageSystem.addRole(new SystemRole(SYSTEM_SHARE_USER, RoleType.GUEST));
        return publicReadonlyStorageSystem;
