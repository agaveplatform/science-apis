...
public interface JobMonitor {
	 ...
	 */
    Job monitor() throws RemoteJobMonitoringException, SystemUnavailableException, ClosedByInterruptException;
	 ...
	 */
    JobStatusResponse<?> getJobStatusResponse(JobStatusResponseParser responseParser, String queryCommand)
	 ...
	 */
    RemoteSubmissionClient getRemoteSubmissionClient() throws SystemUnavailableException, AuthenticationException;
	 ...
	 */
    RemoteDataClient getAuthenticatedRemoteDataClient() throws RemoteDataException, IOException, AuthenticationException, SystemUnavailableException, RemoteCredentialException;
