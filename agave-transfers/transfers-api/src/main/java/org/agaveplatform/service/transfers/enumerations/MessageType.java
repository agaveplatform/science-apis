...
public interface MessageType {                                                                      // type         Ack
    ...
    String  TRANSFERTASK_CANCELED_SYNC = "transfertask_canceled_sync";          // subscribe, Explicit
    String  TRANSFERTASK_CANCELED_COMPLETED = "transfertask_canceled_completed";// subscribe, Explicit
    String  TRANSFERTASK_CANCELED_ACK = "transfertask_canceled_ack";            // subscribe, Explicit
    String 	TRANSFERTASK_CANCELED = "transfertask_canceled";                    // push, None
    String 	TRANSFERTASK_PAUSED = "transfertask_paused";                        // push, None
    String 	TRANSFERTASK_PAUSED_SYNC = "transfertask_paused_sync";              // subscribe, None
    String 	TRANSFERTASK_PAUSED_COMPLETED = "transfertask_paused_completed";    // subscribe, None
    String 	TRANSFERTASK_PAUSED_ACK = "transfertask_paused_ack";                // subscribe, None
    ...
    String 	TRANSFERTASK_PARENT_ERROR = "transfertask_parent_error";            // subscribe, Explicit
...
String 	TRANSFERTASK_DB_QUEUE = "transfertask_db_queue";                    // subscribe, Explicit
    String 	TRANSFERTASK_DELETED = "transfertask_deleted";                      // push, Explicit
    String 	TRANSFERTASK_DELETED_SYNC = "transfertask_deleted_sync";            // subscribe, Explicit
    String 	TRANSFERTASK_DELETED_COMPLETED = "transfertask_deleted_completed";  // subscribe, Explicit
    String 	TRANSFERTASK_DELETED_ACK = "transfertask_deleted_ack";              // subscribe, Explicit
    String 	TRANSFERTASK_UPDATED = "transfertask_updated";                      // subscribe, Explicit
    String 	TRANSFERTASK_PROCESS_UNARY = "transfertask_process_unary";          // subscribe, Explicit
    ...
    String  TRANSFERTASK_HEALTHCHECK_PARENT = "transfertask_healthcheck_parent";// subscribe, Explicit
