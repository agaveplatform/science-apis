...
public interface RemoteSchedulerJobStatus<T> {
     ...
     * @return list of {@link T} associated with an active job status
     */
    List<T> getUnrecoverableStatuses();
     ...
     */
    JobStatusType getMappedJobStatusType();
}
