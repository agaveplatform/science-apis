...
public class SystemsDaoIT extends PersistedSystemsModelTestCommon {
...
//        System.out.println(" exception thrown?  expected " + shouldThrowException + " actual " + actuallyThrewException);
	...
	throws Exception 
	{
		...
		try 
		{
			system.getUsersUsingAsDefault().add(SYSTEM_USER);
			dao.persist(system);
...
//        System.out.println(" exception thrown?  expected false actual " + actuallyThrewException);
	...
	throws Exception 
	{
		...
		try 
		{
			SystemRole userRole = new SystemRole(SYSTEM_USER, role);
...
//        System.out.println(" exception thrown?  expected " + shouldThrowException + " actual " + actuallyThrewException);
	...
	throws Exception 
	{
		...
		try 
		{
			SystemRole role = new SystemRole(SYSTEM_USER, originalType);
			system.addRole(role);
			dao.persist(system);
...
//			dao.persist(system);
			system.addRole(new SystemRole(SYSTEM_USER, updateType));
			dao.persist(system);
