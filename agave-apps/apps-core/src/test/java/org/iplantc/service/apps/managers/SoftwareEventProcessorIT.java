...
public class SoftwareEventProcessorIT extends AbstractDaoTest {
    ...
    protected Object[][] doJobEventsProvider() throws Exception {
    	...
    	ObjectNode privateSoftwareJson = mapper.createObjectNode();
    	privateSoftwareJson.set("app", mapper.readTree(privateSoftware.toJSON()));
    	
    	ObjectNode publicSoftwareJson = mapper.createObjectNode();
