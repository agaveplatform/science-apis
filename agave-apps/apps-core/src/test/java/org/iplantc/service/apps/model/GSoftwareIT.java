...
public class GSoftwareIT extends GModelTestCommon {
    ...
    public Object[][] createData1() {
        return jtd.genJsonTestMessages();
    }
...
//	}
    ...
    public Object[][] defaultProcessorsSanityChecksProvider() 
    {
    	...
    	return new Object[][] {
    			...
    			{ batchQueueNodesField, null, softwareNodesField, (long) -1, false, "software." + softwareNodesField + " cannot be negative when queue." + batchQueueNodesField + " is null", true },
    			{ batchQueueNodesField, null, softwareNodesField, 0L, false, "software." + softwareNodesField + " can not be 0 when queue." + batchQueueNodesField + " is null", true },
    			{ batchQueueNodesField, null, softwareNodesField, 1L, false, "software." + softwareNodesField + " can be any positive integer when queue." + batchQueueNodesField + " is null", false },
    			
    			{ batchQueueNodesField, (long) -1, softwareNodesField, null, false, "software." + softwareNodesField + " can be null when queue." + batchQueueNodesField + " is -1", false },
    			{ batchQueueNodesField, (long) -1, softwareNodesField, (long) -1, false, "software." + softwareNodesField + " cannot be negative when queue." + batchQueueNodesField + " is -1", true },
    			{ batchQueueNodesField, (long) -1, softwareNodesField, 0L, false, "software." + softwareNodesField + " can not be 0 when queue." + batchQueueNodesField + " is -1", true },
    			{ batchQueueNodesField, (long) -1, softwareNodesField, 1L, false, "software." + softwareNodesField + " can be any positive integer when queue." + batchQueueNodesField + " = -1", false },
    			
    			{ batchQueueNodesField, 1L, softwareNodesField, null, false, "software." + softwareNodesField + " can be null when queue." + batchQueueNodesField + " is 1", false },
    			{ batchQueueNodesField, 1L, softwareNodesField, (long) -1, false, "software." + softwareNodesField + " cannot be negative when queue." + batchQueueNodesField + " is 1", true },
    			{ batchQueueNodesField, 1L, softwareNodesField, 1L, false, "software." + softwareNodesField + " can be equal to queue." + batchQueueNodesField + "", false },
    			{ batchQueueNodesField, 1L, softwareNodesField, 0L, false, "software." + softwareNodesField + " can not be 0", true },
    			{ batchQueueNodesField, 1L, softwareNodesField, 2L, false, "software." + softwareNodesField + " cannot be greater than queue." + batchQueueNodesField + "", true },
    			...
    			{ batchQueueProcessorsField, null, softwareProcessorsField, (long) -1, false, "software." + softwareProcessorsField + " cannot be negative when queue." + batchQueueProcessorsField + " is null", true },
    			{ batchQueueProcessorsField, null, softwareProcessorsField, 0L, false, "software." + softwareProcessorsField + " can not be 0 when queue." + batchQueueProcessorsField + " is null", true },
    			{ batchQueueProcessorsField, null, softwareProcessorsField, 1L, false, "software." + softwareProcessorsField + " can be any positive integer when queue." + batchQueueProcessorsField + " is null", false },
    			
    			{ batchQueueProcessorsField, (long) -1, softwareProcessorsField, null, false, "software." + softwareProcessorsField + " can be null when queue." + batchQueueProcessorsField + " is -1", false },
    			{ batchQueueProcessorsField, (long) -1, softwareProcessorsField, (long) -1, false, "software." + softwareProcessorsField + " cannot be negative when queue." + batchQueueProcessorsField + " is -1", true },
    			{ batchQueueProcessorsField, (long) -1, softwareProcessorsField, 0L, false, "software." + softwareProcessorsField + " can not be 0 when queue." + batchQueueProcessorsField + " is -1", true },
    			{ batchQueueProcessorsField, (long) -1, softwareProcessorsField, 1L, false, "software." + softwareProcessorsField + " can be any positive integer when queue." + batchQueueProcessorsField + " = -1", false },
    			
    			{ batchQueueProcessorsField, 1L, softwareProcessorsField, null, false, "software." + softwareProcessorsField + " can be null when queue." + batchQueueProcessorsField + " is 1", false },
    			{ batchQueueProcessorsField, 1L, softwareProcessorsField, (long) -1, false, "software." + softwareProcessorsField + " cannot be negative when queue." + batchQueueProcessorsField + " is 1", true },
    			{ batchQueueProcessorsField, 1L, softwareProcessorsField, 1L, false, "software." + softwareProcessorsField + " can be equal to queue." + batchQueueProcessorsField + "", false },
    			{ batchQueueProcessorsField, 1L, softwareProcessorsField, 0L, false, "software." + softwareProcessorsField + " can not be 0", true },
    			{ batchQueueProcessorsField, 1L, softwareProcessorsField, 2L, false, "software." + softwareProcessorsField + " cannot be greater than queue." + batchQueueProcessorsField + "", true },
    			...
    			{ batchQueueMemoryField, null, softwareMemoryField, (long) -1, false, "software." + softwareMemoryField + " cannot be negative when queue." + batchQueueMemoryField + " is null", true },
    			{ batchQueueMemoryField, null, softwareMemoryField, 0L, false, "software." + softwareMemoryField + " can not be 0 when queue." + batchQueueMemoryField + " is null", true },
    			{ batchQueueMemoryField, null, softwareMemoryField, 1L, false, "software." + softwareMemoryField + " can be any positive integer when queue." + batchQueueMemoryField + " is null", false },
    			...
    			{ batchQueueMemoryField, "-1GB", softwareMemoryField, (long) -1, false, "software." + softwareMemoryField + " cannot be negative when queue." + batchQueueMemoryField + " is -1", true },
    			{ batchQueueMemoryField, "-1GB", softwareMemoryField, 0L, false, "software." + softwareMemoryField + " can not be 0 when queue." + batchQueueMemoryField + " is -1", true },
    			{ batchQueueMemoryField, "-1GB", softwareMemoryField, 1L, false, "software." + softwareMemoryField + " can be any positive integer when queue." + batchQueueMemoryField + " = -1", false },
     ...
     * @param batchQueueField
     * @param batchQueueValue
     * @param softwareField
     * @param softwareValue
    ...
    public void defaultDefaultParametersSanityChecks(String batchQueueField,
	...
	throws Exception 
    {
        ...
        catch(JSONException e)
        {
        	...
        	try { systemDao.remove(executionSystem); } catch (Throwable ignored) {}
        }
    ...
    public void cloneCopiesSoftwareAttributes() {
        try {
            ...
            software.setDefaultNodes(2L);
            software.setDefaultProcessorsPerNode(12L);
