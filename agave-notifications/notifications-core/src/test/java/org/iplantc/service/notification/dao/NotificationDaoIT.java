...
{
	private final int totalActiveValidSpecificNotifications = 7;// totalActiveValidSpecificNotificationsForUser + totalActiveValidSpecificNotificationsForStranger;
	private final int totalActiveValidSpecificNotificationsForUser = 6;
	private final int totalActiveValidSpecificNotificationsForStranger = 1;
	
	private final int totalActiveValidWildcardUuidNotifications = 2;//totalActiveValidWildcardUuidNotificationsForUser + totalActiveValidWildcardUuidNotificationsForStranger;
	private final int totalActiveValidWildcardUuidNotificationsForUser = 1;
	private final int totalActiveValidWildcardUuidNotificationsForStranger = 1;
	
	private final int totalActiveDecoySpecificNotifications = 2;//totalActiveDecoySpecificNotificationsForUser + totalActiveDecoySpecificNotificationsForStranger;
	private final int totalActiveDecoySpecificNotificationsForUser = 1;
	private final int totalActiveDecoySpecificNotificationsForStranger = 1;
	
	// active notification rollup
	private final int totalActiveValidNotifications = 9;//totalActiveValidSpecificNotifications + totalActiveValidWildcardUuidNotifications;
	private final int totalActiveValidNotificationsForUser = 7;//totalActiveValidSpecificNotificationsForUser + totalActiveValidWildcardUuidNotificationsForUser;
	private final int totalActiveValidNotificationsForStranger = 2;//totalActiveValidSpecificNotificationsForStranger + totalActiveValidWildcardUuidNotificationsForStranger;
	
	private final int totalActiveDecoyNotifications = 4;//totalActiveValidWildcardUuidNotifications + totalActiveDecoySpecificNotifications;
	private final int totalActiveDecoyNotificationsForUser = 2;//totalActiveValidWildcardUuidNotificationsForUser + totalActiveDecoySpecificNotificationsForUser;
	private final int totalActiveDecoyNotificationsForStranger = 2;//totalActiveValidWildcardUuidNotificationsForStranger + totalActiveDecoySpecificNotificationsForStranger;
	
	private final int totalActiveNotifications = 11;//totalActiveNotificationsForUser + totalActiveNotificationsForStranger;
	private final int totalActiveNotificationsForUser = 8;//totalActiveValidSpecificNotificationsForUser + totalActiveValidWildcardUuidNotificationsForUser + totalActiveDecoySpecificNotificationsForStranger;
	private final int totalActiveNotificationsForStranger = 3;//totalActiveValidSpecificNotificationsForStranger + totalActiveValidWildcardUuidNotificationsForStranger + totalActiveDecoySpecificNotificationsForStranger;
	
	// expired notifications
	private final int totalPastSpecificNotifications = 3;//totalPastSpecificNotificationsForUser + totalPastSpecificNotificationsForStranger;
	private final int totalPastSpecificNotificationsForUser = 2;
	private final int totalPastSpecificNotificationsForStranger = 1;
	
	private final int totalPastWildcardNotifications = 2;//totalPastWildcardNotificationsForUser + totalPastWildcardNotificationsForStranger;
	private final int totalPastWildcardNotificationsForUser = 1;
	private final int totalPastWildcardNotificationsForStranger = 1;
	
	private final int totalPastDecoySpecificNotifications = 2;//totalPastDecoyNotificationsForUser + totalPastDecoyNotificationsForStranger;
	private final int totalPastDecoySpecificNotificationsForUser = 1;
	private final int totalPastDecoySpecificNotificationsForStranger = 1;
	
	
	// expired notification rollups
	private final int totalPastValidNotifications = 5;//totalPastSpecificNotifications + totalPastWildcardNotifications;
	private final int totalPastValidNotificationsForUser = 3;//totalPastSpecificNotificationsForUser + totalPastWildcardNotificationsForUser;
	private final int totalPastValidNotificationsForStranger = 2;//totalPastSpecificNotificationsForStranger + totalPastWildcardNotificationsForStranger;

	private final int totalPastDecoyNotifications = 4;//totalPastDecoySpecificNotifications + totalPastWildcardNotifications;
	private final int totalPastDecoyNotificationsForUser = 2;//totalPastWildcardNotificationsForUser + totalPastDecoySpecificNotificationsForUser;
	private final int totalPastDecoyNotificationsForStranger = 2;//totalPastWildcardNotificationsForStranger + totalPastDecoySpecificNotificationsForStranger;
	
	private final int totalPastNotifications = 7;//totalPastSpecificNotifications + totalPastWildcardNotifications + totalPastDecoySpecificNotifications;
	
	// overall rollups
	private final int totalNotifications = 18;//totalActiveNotifications + totalPastNotifications;
