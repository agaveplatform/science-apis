...
$config['iplant.database.usage.table.name'] = envVar('IPLANT_DB_USAGE_TABLE','Usage');

$config['iplant.database']['foundation']['host'] = envVar('FOUNDATION_MYSQL_HOST', 'mysql');
$config['iplant.database']['foundation']['username'] = envVar('FOUNDATION_MYSQL_USERNAME','agaveuser');
$config['iplant.database']['foundation']['password'] = envVar('FOUNDATION_MYSQL_PASSWORD','password');
$config['iplant.database']['foundation']['name'] = envVar('FOUNDATION_MYSQL_DATABASE','iplant-api');
...
$config['iplant.database']['agave']['host'] = envVar('MYSQL_HOST', 'mysql');
$config['iplant.database']['agave']['username'] = envVar('MYSQL_USERNAME','agaveuser');
$config['iplant.database']['agave']['password'] = envVar('MYSQL_PASSWORD','password');
$config['iplant.database']['agave']['name'] = envVar('MYSQL_DATABASE','agavecore');
