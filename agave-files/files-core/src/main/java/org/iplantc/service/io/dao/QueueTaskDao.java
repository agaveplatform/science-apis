...
//			return tt;
            ...
            transfer.put("src", file.getSourceUri());
            ...
            if (connection.getResponseCode() == 200){
                ...
                JsonObject jsonResponse = new ObjectMapper().readValue(response.toString(), JsonObject.class);
                file.setTransferUuid(jsonResponse.getString("uuid"));
