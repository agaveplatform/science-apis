...
{
	private static final HashMap<String, String> searchTermMappings = new HashMap<String,String>();

	@SuppressWarnings("rawtypes")
	private static final HashMap<String, Class> searchTypeMappings = new HashMap<String,Class>();
