...
public interface MessageQueueClient {
	 ...
	 */
    void push(String exchange, String queue, String message) throws MessagingException;
	 ...
	 * @throws MessagingException if communication with the queue fails
	 */
    void push(String exchange, String queue, String message, int secondsToDelay) throws MessagingException;
	 ...
	 * @throws MessagingException if communication with the queue fails
	 */
    void reject(String exchange, String queue, Object messageId, String message) throws MessagingException;
	 ...
	 * @throws MessagingException if communication with the queue fails
	 */
    void delete(String exchange, String queue, Object messageId) throws MessagingException;
	 ...
	 * @throws MessagingException if communication with the queue fails
	 */
    Message pop(String exchange, String queue) throws MessagingException;
	 ...
	 * @throws MessagingException if communication with the queue fails
	 */
    List<Message> pop(String exchange, String queue, int count) throws MessagingException;
...
//	
	 ...
	 * @throws MessagingException if communication with the queue fails
	 */
    boolean touch(Object messageId, String queue) throws MessagingException;
	 ...
	 * @throws MessagingException if communication with the queue fails
	 */
    void listen(String exchange, String queue, MessageQueueListener listener)
	 ...
	 */
    List<Object> listQueues() throws MessagingException, NotImplementedException;
     ...
     * @throws NotImplementedException if the underlying service does not support messaging
     */
    List<String> listQueueNames() throws MessagingException, NotImplementedException;
	 ...
	 * @throws MessagingException if communication with the queue fails
	 */
    boolean queueExist(String queueName) throws MessagingException;
	 ...
	 * @throws MessagingException if communication with the queue fails
	 */
    String findQueueMatching(String regex) throws MessagingException;
	 ...
	 * @throws MessagingException if communication with the queue fails
	 */
    boolean messageExist(String queue, Object messageId) throws MessagingException;
	 ...
	 */
    Message reserve(String exchange, String queue, int timeout)
