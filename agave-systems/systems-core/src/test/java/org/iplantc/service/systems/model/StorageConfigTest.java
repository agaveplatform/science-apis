...
public class StorageConfigTest extends SystemsModelTestCommon {
    ...
    public Object[][] storageConfigName() {
        return new Object[][]{
                ...
                {"host", Collections.singletonList("Harry"), "host cannot be array", true},
                ...
                {"rootDir", Collections.singletonList("Harry"), "rootDir cannot be array", true},
                ...
                {"port", Collections.singletonList("Harry"), "port cannot be array", true},
                {"port", 22.0f, "port is rounded when a floating point number", false},
                {"port", null, "port can be null", true},
                {"port", -1, "port cannot be negative", true},
                {"port", 22, "port can be an integer", false},
                ...
                {"protocol", Collections.singletonList("Harry"), "protocol cannot be array", true},
                ...
                {"auth", Collections.singletonList("Harry"), "auth config cannot be array", true},
        };
    }

    @Test(groups = {"model", "system", "unit"}, dataProvider = "storageConfigName")
    public void storageConfigNameValidationTest(String name, Object changeValue, String message, boolean shouldExceptionBeThrown) throws Exception {
        ...
        Assert.assertEquals(exceptionFlag, shouldExceptionBeThrown, exceptionMsg);
    ...
    public Object[][] storageConfigIrods() {
        return new Object[][]{
                ...
                {"zone", Collections.singletonList("Harry"), "zone cannot be array for irods config", true},
                ...
                {"resource", Collections.singletonList("Harry"), "resource cannot be array for irods config", true},
    ...
    @Test(groups = {"model", "system", "unit"}, dataProvider = "storageConfigIrods")
    public void storageConfigIrodsValidationTest(String name, Object changeValue, String message, boolean shouldExceptionBeThrown)
        ...
        Assert.assertEquals(shouldExceptionBeThrown, exceptionFlag, exceptionMsg);
    }
...
//                jsonTree.getJSONObject("auth").put("credential", serializedCredential);
    ...
    @Test(groups = {"model", "system", "unit"}, dataProvider = "cloneProvider")
    ...
    @Test(groups = {"model", "system", "unit"}, dataProvider = "addAuthConfigProvider")
    public void addAuthConfigTest(StorageProtocolType protocol, AuthConfigType authConfigType, String message, boolean shouldThrowException)
        ...
        Assert.assertEquals(shouldThrowException, exceptionFlag, exceptionMsg);
    }
