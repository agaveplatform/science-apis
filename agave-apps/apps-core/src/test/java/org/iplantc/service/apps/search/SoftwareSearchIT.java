...
public class SoftwareSearchIT extends AbstractDaoTest {
	...
	public Object[][] findMatchingOntologyProvider() throws Exception
	{
		...
		for (int i=0; i<ontologies.size(); i++) {
			...
			testCases.add(new Object[]{ontologies, "ontology.like", "*" + ontology + "*", true});
			testCases.add(new Object[]{ontologies, "ontology.like", "*" + ontology, false});
			testCases.add(new Object[]{ontologies, "ontology.like", ontology + "*", false});
		}
	...
	public Object[][] findMatchingTagProvider() throws Exception
	{
		...
		for (int i=0; i<ontologies.size(); i++) {
			...
			testCases.add(new Object[]{ontologies, "tags.like", "*" + ontology + "*", true});
			testCases.add(new Object[]{ontologies, "tags.like", "*" + ontology, false});
			testCases.add(new Object[]{ontologies, "tags.like", ontology + "*", false});
		}
		return testCases.toArray(new Object[][]{});
	}
