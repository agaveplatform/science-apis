...
public class SystemSearchWithFieldFilterIT extends PersistedSystemsModelTestCommon {
...
//	}
    ...
    private ExecutionSystem createExecutionSystem() throws Exception {
        ...
        ExecutionSystem system = ExecutionSystem.fromJSON(systemJson);
...
//                {"lastupdated", new DateTime(system.getLastUpdated()).toString()},
    ...
    public void findMatchingTime(String attribute, Object value) throws Exception {
        ...
        Map<String, String> map = new HashMap<String, String>();
        map.put("lastupdated.ON", formatter.format(system.getLastUpdated()));
        ...
        map.clear();
        map.put("created.ON", formatter.format(system.getCreated()));
